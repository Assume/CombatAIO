...
public class MonsterArea {
	...
	public static final RSArea RELLEKKA_ROCK_CRABS_EAST = new RSArea(new RSTile[]{
			new RSTile(2691, 3738, 0),
			new RSTile(2693, 3712, 0),
			new RSTile(2728, 3711, 0),
			new RSTile(2725, 3740, 0)}
	);
