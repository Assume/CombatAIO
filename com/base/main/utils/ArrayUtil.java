...
public class ArrayUtil {
	...
	public static <T extends Object> T[] filterDuplicates(T[] array) {
		...
		return set
				.toArray((T[]) Array.newInstance(array.getClass(), set.size()));
	}
	 ...
	 *            The array to check.
	 * @param i
	 *            The x value to be retrieved from the 2D array.
	 * @param j
	 *            The y value to be retrieved from the 2D array.
			...
			for (String s : array) {
				if (s != null) {
					if (string.toLowerCase().contains(s.toLowerCase())
							|| s.toLowerCase().contains(string.toLowerCase())) {
						return true;
					}
				}
			}
	 ...
	 * 
	 * @param array
	 *            The ArrayList being tested.
	 * @param stringArray
	 *            The ArrayList of Strings to be searched for.
	 ...
	 */
	public static boolean containsPartOf(ArrayList<String> array,
			String... stringArray) {
	 ...
	 * @param arr
	 *            The array that is being searched through.
