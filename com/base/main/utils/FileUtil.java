...
public class FileUtil {
	...
	/**
	 * Returns the Sigma directory that is located in the TRiBot working
	 * directory.
	 * 
	 * @return The Sigma directory that is located in the TRiBot working
	 *         directory.
	 */
	 ...
	 * @param path
	 *            The directory path to be saved in.
	 ...
	 *            false if the file should be returned regardless of its
	 *            existence.
	 * @param fileName
	 *            The name of the file.
	 * @param extension
	 *            The extension of the file (dot not included).
	 * @param dirPath
	 *            The directory path of the file. Null if the path should be the
	 *            default directory only.
	 * @return a File located in the TRiBot directory folder.
	 */
	public static File getFile(boolean checkExists, String fileName,
			String extension, String... dirPath) {
	 ...
	 * @param path
	 *            The directory path to the directory being returned.
	 * @return the directory located in the TRiBot directory folder represented
	 *         by the specified directory path.
	 */
	 ...
	 *            contents of the file or not.
	 * @param fileName
	 *            The name of the file that is the be created.
	 * @param extension
	 *            The extention that the file is to have.
	 * @param dirPath
	 *            The directory path to the file that is being created.
	 * @return true if the specified file exists at the end of execution
	 *         (regardless if it had already existed), and false otherwise.
	 */
	public static boolean createFile(boolean shouldWipe, String fileName,
			String extension, String... dirPath) {
	 ...
	 * @return true if the specified directory exists at the end of execution
	 *         (regardless if it had already existed), and false otherwise.
	 */
	 ...
	 * @param dirPath
	 *            The directory path that the file will take.
	 * @return false if the specified directory exists at the end of execution
	 *         (regardless if it didn't exist to begin with), and true
	 *         otherwise.
	 */
	 ...
	 *            The extension of the file.
	 * @param dirPath
	 *            The directory path to the file that is being read.
	 * @return the contents of the specified text file.
	 */
	public static String getTextFileContentsExt(String fileName,
			String extension, String... dirPath) {
		File file = getFile(false, fileName, extension, dirPath);
	...
	public static void traverseTextFile(TextTraversable traversable,
			String fileName, String extension, String... dirPath) {
		File file = getFile(false, fileName, extension, dirPath);
	 ...
	 * @param fileName
	 *            The name of the file that is being written to.s
	 * @param overwrite
	 *            True if the contents should be overwritten, false otherwise.
	 * @param dirPath
	 *            The directory path to the file that is being written to.
	 * @return Whether or not the file was successfully written to.
	 */
	public static boolean writeTextFileContents(String text, String fileName,
			boolean overwrite, String... dirPath) {
	 ...
	 *            The name of the file that is being written to.s
	 * @param extension
	 *            The extension of the file being read to without the dot.
	 * @param overwrite
	 *            True if the contents should be overwritten, false otherwise.
	 * @param dirPath
	 *            The directory path to the file that is being written to.
	 ...
	 */
	public static boolean writeTextFileContents(String text, String fileName,
			String extension, boolean overwrite, String... dirPath) {
	 ...
	 * @param overwrite
	 *            True if the existing text should be overwritten, false
	 *            otherwise.
	 * @return Whether or not the file was successfully written to.
	 */
	...
	/**
	 * Returns all of the files in the specified directory that match the
	 * specified requirements, or null if the directory does not exist.
	 * 
	 * If any part of the absolute file path (including the extension) contain
	 * the specified string, then the file will be included in the returned
	 * array. The requirements are not case sensitive.
	 * 
	 * @param reqs
	 *            The requirements.
	 * @param dirPath
	 *            The path.
	 * @return All of the files in the specified directory that match the
	 *         specified requirements, or null if the directory does not exist.
	 */
	public static File[] getFilesInDirectory(final String reqs,
